...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($feedback)) {
        // Assuming `status` represents whether the operation was successful
        $status = addfeedback($report_id, $petugas_id, $feedback, $conn); // Call the addfeedback function
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-success">Tambahkan Feedback Untuk Laporan Dengan ID <?= $report_id?></h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <form method="POST">
