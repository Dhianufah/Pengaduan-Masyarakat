                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 d-none d-lg-block bg-login-image">
                                <dotlottie-player src="https://lottie.host/850cef82-dc4b-4a32-8277-c6cb52ef55d9/TNQPUA8Axw.json" background="transparent" speed="1" style="width: 500px; height: 500px;" loop autoplay></dotlottie-player>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <h3 class="h6 text-gray-900"> Hadir untuk menampung semua keluhanmu</h3>
                                    </div>
